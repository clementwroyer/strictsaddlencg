...
However, what I am currently working on is proving that after $m$ iterations done ine Regime~3,
($k_0 + m$), we stay in Regime~3.
The last section of the current draft contains the proofs attempts.
